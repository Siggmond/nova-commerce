class AppEnv {
  ...
  static const String paymentsProvider = String.fromEnvironment(
    'PAYMENTS_PROVIDER',
    defaultValue: 'fake',
  );

  static const String paymentsMode = String.fromEnvironment(
    'PAYMENTS_MODE',
    defaultValue: 'demo',
  );

  static const String paymentsDemoOutcome = String.fromEnvironment(
    'PAYMENTS_DEMO_OUTCOME',

...
import 'package:nova_commerce/features/auth/domain/entities/auth_account_details.dart';
import 'package:nova_commerce/features/auth/domain/entities/auth_user.dart';
import 'package:nova_commerce/features/auth/domain/repositories/auth_repository.dart';
  ...
  Future<AuthUser> _guard(Future<AuthUser> Function() action) async {
    ...
    try {
      ...
      if (_shouldFallback(e)) {
        final user = await _fallback.signInWithGoogle();
        _useFallback = true;

  ...
  Widget build(BuildContext context) {
    ...
    if (!kReleaseMode) {
      final providerIds =
          ...
          const <String>[];
      debugPrint(
        'Checkout UI auth uid=${authUser?.uid ?? ''} isAnonymous=${authUser?.isAnonymous ?? true} providers=$providerIds',
      );
    }
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            if (!summary.hasItems || !isSignedIn) ...[
              SizedBox(height: 12.h),
              _CheckoutHint(
            ...
            SafeArea(
              ...
              child: useNovaUi
                  ...
                  : FilledButton(
                      onPressed:
                          state.isSubmitting || !summary.hasItems || !isSignedIn
                          ? null
                          : () => vm.submit(),
                      child: Row(

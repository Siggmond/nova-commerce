...
import 'package:nova_commerce/core/widgets/section_card.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        if (icon != null) ...[
          Icon(icon, size: 16.r, color: Theme.of(context).colorScheme.primary),
...
class _OrderDetailsSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        Shimmer(
          child: SkeletonBox(height: 128.h, radius: AppRadii.lg),
        ),
        SizedBox(height: AppSpace.sm),
        Shimmer(
          child: SkeletonBox(height: 120.h, radius: AppRadii.lg),
        ),
        SizedBox(height: AppSpace.sm),
        Shimmer(
          child: SkeletonBox(height: 22.h, radius: AppRadii.sm),
        ),
        SizedBox(height: AppSpace.sm),
        Shimmer(
          child: SkeletonBox(height: 96.h, radius: AppRadii.lg),
        ),
        SizedBox(height: AppSpace.sm),
        Shimmer(
          child: SkeletonBox(height: 96.h, radius: AppRadii.lg),

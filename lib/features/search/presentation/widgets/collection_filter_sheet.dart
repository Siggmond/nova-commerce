...
class _CollectionFilterSheetState extends ConsumerState<CollectionFilterSheet> {
  late SearchFilters _draft;

  @override
  void initState() {
    super.initState();
    _draft = ref.read(collectionFiltersProvider(widget.collectionId));
  }
                      ...
                      TextButton(
                        onPressed: () {
                          final currentQuery = ref
                              .read(
                                collectionFiltersProvider(widget.collectionId),
                              )
                              .query;
                          setState(

...
void main() {
  test('Refresh intermediate empty does not flip ready sections to empty', () {
    final browseState = StateProvider<List<Product>>((ref) => const <Product>[]);
    ...
    final vm = container.read(homeViewModelProvider.notifier) as TestHomeViewModel;
    ...
    expect(_status(container, HomeSectionId.browseResults), HomeSectionStatus.ready);
    expect(_status(container, HomeSectionId.underFeed), HomeSectionStatus.ready);
  ...
  test('EmptyState allowed only after refresh completes and final result is empty', () {
    final browseState = StateProvider<List<Product>>((ref) => const <Product>[]);
    final underState = StateProvider<List<Product>>((ref) => const <Product>[]);
    ...
    expect(_status(container, HomeSectionId.browseResults), HomeSectionStatus.empty);
    expect(_status(container, HomeSectionId.underFeed), HomeSectionStatus.empty);
  });
}

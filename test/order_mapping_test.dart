...
void main() {
  test('OrderDto.fromJson tolerates missing/invalid fields and normalizes items list', () {
    final dto = OrderDto.fromJson(
      ...
      json: {
        ...
        'shipping': {'fullName': 'A'},
        'items': [
          {'productId': 'p1', 'title': 'T', 'price': 10, 'quantity': 1, 'selectedColor': 'Black', 'selectedSize': 'M'},
          'invalid',
          123,
          {'productId': 'p2'},
        ],

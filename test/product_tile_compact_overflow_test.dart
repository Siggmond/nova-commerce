...
void main() {
  testWidgets(
    'ProductTileCompact does not overflow in grid cell with long text',
  ...
  testWidgets(
    'ProductTileCompact does not overflow in horizontal item constraints',
    (WidgetTester tester) async {
      await tester.binding.setSurfaceSize(const Size(390, 844));
      addTearDown(() => tester.binding.setSurfaceSize(null));
